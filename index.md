...
- Notre jardin d’oliviers, au-dessus du hameau, offre une vue imprenable sur le château de Fressac.

## À proximité

Plusieurs lieux méritent une visite ou facilitent votre séjour :
- Le hameau des Montèzes — Site historique abritant la plaque commémorative du [premier synode du Désert](https://fr.wikipedia.org/wiki/Fichier:Plaque_comm%C3%A9morative_du_premier_synode_du_D%C3%A9sert,_aux_Mont%C3%A8zes.jpg){:target="_blank" rel="noopener noreferrer"}
...
- Baignade en rivière.
- Accrobranche.
- Grottes et sites naturels à explorer.
- Musées et sites historiques, notamment liés à l’histoire protestante de la région.
- Cinéma en plein air et festivals locaux en été.
- Visite de caves et dégustations de vins locaux.
- Et bien d’autres activités à découvrir dans les prospectus disponibles dans chaque logement.

## Infos pratiques

Quelques informations utiles pour votre séjour :
